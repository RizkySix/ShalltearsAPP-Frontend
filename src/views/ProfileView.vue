...
<nav class="flex px-5 py-3 text-gray-700 border border-gray-200 bg-gray-50" aria-label="Breadcrumb">
  <ol class="inline-flex items-center mx-auto space-x-1 md:space-x-3">
    <li class="inline-flex items-center">
      <RouterLink v-if="route.name === 'profile'" id="album" :to="'/profile/' + route.params.username" class=" inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-600 ">
        <i class="fa-regular fa-images w-3 h-3 mr-2.5"></i>
        Albums
      </RouterLink>
      <RouterLink v-else id="album" :to="'/profile/' + route.params.username" class=" inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 ">
        <i class="fa-regular fa-images w-3 h-3 mr-2.5"></i>
        Albums
      </RouterLink>
    </li>
    <li>
      <div class="flex items-center">
        ...
        <RouterLink v-if="route.name === 'profile.threads'" id="thread" :to="'/profile/' + route.params.username + '/threads'" class="ml-1 text-sm font-medium text-blue-600 hover:text-blue-600 md:ml-2 ">
          <i class="fa-solid fa-comments w-3 h-3 mr-2.5"></i>
          Threads
        </RouterLink>
        <RouterLink v-else id="thread" :to="'/profile/' + route.params.username + '/threads'" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 ">
          <i class="fa-solid fa-comments w-3 h-3 mr-2.5"></i>
          Threads
        </RouterLink>
      </div>
    ...
    <li v-if="route.params.username == authUser.username" aria-current="page">
      <div class="flex items-center">
        ...
        <RouterLink v-if="route.name === 'archive.album'" id="archive" :to="'/profile/' + route.params.username + '/archive'" class="ml-1 text-sm font-medium text-blue-600 hover:text-blue-600 md:ml-2 ">
          <i class="fa-solid fa-inbox w-3 h-3 mr-2.5"></i>
          Archive
        </RouterLink>
        <RouterLink v-else id="archive" :to="'/profile/' + route.params.username + '/archive'" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 ">
          <i class="fa-solid fa-inbox w-3 h-3 mr-2.5"></i>
          Archive
        </RouterLink>
      </div>
