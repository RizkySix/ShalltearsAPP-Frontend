       ...
       <div v-if="images.length != 0" class="max-h-full">
         ...
         <div class="h-auto p-4">
           <form action="#" @submit.prevent="handleEditAlbum">
            ...
            <textarea v-model="caption" name="caption" id="caption" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="I need more bullets...">
             <pre>
                {{ caption }}
             </pre>
            </textarea>
