<template>
    <div class=" p-5 mx-auto">
        <form action="" @submit.prevent="handleEditThread(slug)">
            ...
            <textarea v-model="newThread" id="thread" rows="6" class="block mt-3 me-1 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tuliskan perasaan mu hari ini..." required>{{ newThread }}</textarea>
