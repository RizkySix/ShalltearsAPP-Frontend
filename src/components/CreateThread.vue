<template>
    <div class=" p-5 mx-auto bg-white rounded-lg">
        <form action="" @submit.prevent="handleCreateThread">
            ...
            <textarea v-model="thread" id="thread" rows="4" class="block mt-3 me-1 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Tuliskan perasaan mu hari ini..." required></textarea>
